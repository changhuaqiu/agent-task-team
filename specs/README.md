...
| 规格 | 状态 | 当前边界 |
| --- | --- | --- |
| [`ux-journey-completion/`](ux-journey-completion/) | active | 修复 UX-01 至 UX-09，形成目标、团队接手、异常处理和成果验收的简单闭环 |
...
| [`command-driven-delivery/`](command-driven-delivery/) | active | 以统一 CommandReceipt、Project 对象面、Automation 和结构化 MCP/CLI 收拢交付事实与创建协议 |
...
| [`project-workitem-hierarchy/`](project-workitem-hierarchy/) | active | 将 Project、工作项、Task 与活动分层；新工作独立定域，旧项目兼容迁移，GitHub Issue 复用 Project |
