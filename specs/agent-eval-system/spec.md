...
> 依赖：[`agent-observability`](../agent-observability/)、[`observability-drilldown`](../observability-drilldown/)、[`system-control-plane`](../system-control-plane/)、[`Platform Harness 长期设计`](../../docs/technical/execution/platform-harness-state-machine-design.md)
