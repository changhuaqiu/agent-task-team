...
- [x] Add a closed legacy Task-status projection at API, hydration, socket and Kanban boundaries.
- [x] Prefer installed pinned ACP adapter binaries while retaining the catalog fallback.
- [x] Enable and verify Claude native-subagent text forwarding on new and resumed sessions.
