...
- [x] 零消费者 `getContract` 删除。
- [x] `getContractRow` 仅为 private helper。
- [x] `listActiveAuthoritiesForTask` 仅为 private helper。
- [x] issue/idempotency 与 authority epoch fencing 保持。
