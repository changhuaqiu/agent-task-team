...
topics: [cdp, antigravity, bengal-agent, browser-automation, dom-scraping, lessons-learned]
...
> **Status**: done | **Owner**: Agent-R/Agent-R
> **Feature**: [F061 Antigravity 接入 — 孟加拉Agent](F061-antigravity-bengal-agent.md)
...
| 维度 | 详情 |
|------|------|
| **症状** | 孟加拉Agent抓回来的内容有重复、包含 thinking 文本、CSS 垃圾 |
...
| 维度 | 详情 |
|------|------|
| **症状** | 孟加拉Agent @ team lead但team lead没收到通知 |
...
## 如果接入网页版 ChatGPT Pro（Agent-M Pro），会遇到同样的事情吗？
