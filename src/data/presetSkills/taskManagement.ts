    ...
    tools: [
      ...
      },
      {
        ...
        parameters: [
          ...
          { name: 'evidence', type: 'object', required: false, description: 'Required for in_review: installResult, buildResult, impactEvidence. Required for done: mergedToMain, mainInstallResult, mainBuildResult, mainTestResult, mainImpactReviewResult.' },
        ],
