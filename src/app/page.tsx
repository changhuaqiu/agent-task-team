...
import { Plus, Hash, UserPlus } from 'lucide-react';
...
export default function Home() {
  ...
  return (
    <main className="min-h-screen flex flex-col bg-[hsl(var(--bg-app))]">
      {/* ── Header ── */}
      <header className="px-6 py-4 border-b border-[hsl(var(--border))] flex items-center justify-between sticky top-0 bg-[hsl(var(--bg-app)/0.85)] backdrop-blur-md z-30">
        <div className="flex items-center gap-3">
          {/* Logo */}
          <div className="w-9 h-9 bg-[hsl(var(--accent))] text-white rounded-[4px] flex items-center justify-center shadow-[2px_2px_0px_hsl(var(--text-primary))] border-2 border-[hsl(var(--text-primary))]">
