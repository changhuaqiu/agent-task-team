...
- **设计依据**：`docs/technical/execution/context-layering.md` §3（标签）、§8（BudgetGuard 改造）、§9（可见性）。
...
- 设计依据: docs/technical/execution/context-layering.md §8
...
// docs/technical/execution/context-layering.md §3, §9
...
- 设计依据: docs/technical/execution/context-layering.md §3, §9
...
- 设计依据: docs/technical/execution/context-layering.md §9, §12
