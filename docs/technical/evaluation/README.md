...
- `2026-09-05-task-graph-activation-reconciliation-evaluation.md`：accepted Coordinator Task Graph 的全图激活、历史重放恢复、依赖调度、pending Inbox 去重与 WorkItem 停滞可见性 C 级对比（已接受；不代表总体 Agent 完成率结论）。
