...
> 关联：`specs/context-manager/spec.md`（实现 spec，本设计是其分层与边界的重构依据）、`docs/daily/2026-07-14-collab-efficiency-retro.md`（协作效率复盘·元病灶）、`specs/context-budget-management/`（预算守护，被复用）
